...
export default function Signup() {
  ...
  function onConfirmChange(e) {
    ...
    setConfirmMsg(f.password.value && e.target.value !== f.password.value ? 'Passwords do not match.' : '')
  }
    ...
    <div className="formSignup">
      ...
      <form id="signup" onSubmit={onSubmit}>
        <div className="email">
          ...
          <input type="email" id="email" name="email" autoComplete="email" required />  {/* Changed to type="email" for better validation */}
        </div>
        ...
        <div>
          ...
          <input type="password" id="confirm" name="confirm" autoComplete="new-password" minLength="8" required onChange={onConfirmChange} />
          {/* <div>{confirmMsg}</div>  {"Password match!"} */}
          <div id="error" role="alert" aria-live="polite">{error}</div>  {"Password do not match!"}
        </div>
